...
import {
  siGit, siDocker, siKubernetes, siNpm, siNodedotjs,
  siPython, siJavascript, siTypescript, siRust, siCplusplus,
  siGithub, siGnubash,
} from 'simple-icons';

export interface Brand { svg: string; hex: string; }

// 키 = config 의 icon 키. 없는 키(java/c/http/cron/regex 등)는 도형 fallback.
export const brandAssets: Record<string, Brand> = {
...
export function logoTexture(key: string | undefined): string | null {
